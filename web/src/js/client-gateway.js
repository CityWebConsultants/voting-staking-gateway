        ...
        */
        ...
        EthPaymentGatewayBase.prototype.getTransactionReceiptFromNetwork = function (txHash) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.web3Instance.eth.getTransactionReceipt(txHash)];
                        case 1:
                            txReceipt = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            contract = _a.sent();
                            return [4 /*yield*/, contract.withdrawPayment(merchant)];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            contract = _a.sent();
                            priceInWei = this.baseClass.web3Instance.toWei(ether, 'ether');
                            return [4 /*yield*/, contract.makePayment(merchant, reference, { value: priceInWei })];
                        case 2:
                            result = _a.sent();
                            return [2 /*return*/, result];
                    }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            contract = _a.sent();
                            return [4 /*yield*/, contract.makePaymentInTokens(merchant, reference, tokenAmount)];
                        case 2:
                            result = _a.sent();
                            return [2 /*return*/, result];
                    }
