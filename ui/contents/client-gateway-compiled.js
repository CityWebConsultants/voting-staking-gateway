...
System.register("EthPaymentGatewayBase", ["web3"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var web3_1, EthPaymentGatewayBase;
    return {
        setters: [
            function (web3_1_1) {
                web3_1 = web3_1_1;
        ...
        execute: function () {
            EthPaymentGatewayBase = /** @class */ (function () {
                function EthPaymentGatewayBase(network, contractAddress) {
                    this.contractAbiUrl = "";
                    this.web3Instance = new web3_1["default"](new web3_1["default"].providers.HttpProvider(network));
                    this.contractAddress = contractAddress;
                }
                EthPaymentGatewayBase.prototype.getContract = function () {
                    return __awaiter(this, void 0, void 0, function () {
                        var contractAbi, contract;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.getContractAbi()];
                                case 1:
                                    contractAbi = _a.sent();
                                    return [4 /*yield*/, new this.web3Instance.eth.Contract(contractAbi, this.contractAddress)];
                                case 2:
                                    contract = _a.sent();
                ...
                EthPaymentGatewayBase.prototype.getContractAbi = function () {
                    return __awaiter(this, void 0, void 0, function () {
                        var response, data;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, fetch(this.contractAbiUrl)];
                                case 1:
                                    response = _a.sent();
            ...
            exports_1("EthPaymentGatewayBase", EthPaymentGatewayBase);
        }
    };
});
///<reference path="EthPaymentGatewayBase.ts"/>
System.register("EthPaymentGatewayClient", ["EthPaymentGatewayBase"], function (exports_2, context_2) {
    "use strict";
    var __moduleName = context_2 && context_2.id;
    var EthPaymentGatewayBase_1, EthPaymentGatewayClient;
    return {
        setters: [
            function (EthPaymentGatewayBase_1_1) {
                EthPaymentGatewayBase_1 = EthPaymentGatewayBase_1_1;
            }
        ],
        execute: function () {///<reference path="EthPaymentGatewayBase.ts"/>
            EthPaymentGatewayClient = /** @class */ (function () {
                function EthPaymentGatewayClient(network, contractAddress) {
                    this.baseClass = new EthPaymentGatewayBase_1.EthPaymentGatewayBase(network, contractAddress);
                }
                EthPaymentGatewayClient.prototype.tester = function () {
                    alert("something");
                };
                return EthPaymentGatewayClient;
            }());
            exports_2("EthPaymentGatewayClient", EthPaymentGatewayClient);
        }
    };
});
...
/***/ }
/******/ ]);
//# sourceMappingURL=client-gateway-compiled.js.map